...
const PERMS = {
  ...
  'cust.edit'     : 'เพิ่ม-แก้ทะเบียนลูกค้า และราคาที่ตกลง',
  'price.edit'    : 'ตั้งราคาขาย เรตตามจำนวน และโปรโมชั่น',
  'sale.backdate' : 'กรอก-แก้ยอดขายย้อนหลัง',
  'mat.cost'      : 'ดูและแก้ต้นทุนวัตถุดิบ',
  'expense.log'   : 'บันทึกและแก้ค่าใช้จ่าย',
...
const ROLES = {
  ...
  warehouse_lead: { name:'หัวหน้าคลัง', dept:'คลังสินค้า', nameEn:'Warehouse supervisor',
    perms:['sell.walk','sell.wholesale','sell.delete','produce.log','mat.move','stock.count','master.edit','cust.edit','report.export','mat.cost'] },
  ...
  accounting: { name:'บัญชี / การเงิน', dept:'บัญชี', nameEn:'Accounting / Finance',
    perms:['money.view','report.export','sell.delete','cust.edit','price.edit','sale.backdate','mat.cost','expense.log'] },
  ...
  purchasing: { name:'จัดซื้อ', dept:'จัดซื้อ', nameEn:'Purchasing (materials + cost view)',
    perms:['mat.move','stock.count','money.view','report.export','mat.cost','master.edit'] },
  office    : { name:'ธุรการ / ออฟฟิศ', dept:'สำนักงาน', nameEn:'Office admin',
    perms:['produce.log','stock.count','report.export','cust.edit','expense.log','money.view'] },
