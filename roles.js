...
const ROLES = {
  ...
  warehouse_lead: { name:'หัวหน้าคลัง', dept:'คลังสินค้า', nameEn:'Warehouse supervisor',
    perms:['sell.walk','sell.wholesale','sell.delete','produce.log','mat.move','stock.count','master.edit','cust.edit','report.export'] },
  ...
  accounting: { name:'บัญชี / การเงิน', dept:'บัญชี', nameEn:'Accounting / Finance',
    perms:['money.view','report.export','sell.delete','cust.edit','price.edit','sale.backdate'] },
  ...
  office    : { name:'ธุรการ / ออฟฟิศ', dept:'สำนักงาน', nameEn:'Office admin',
    perms:['produce.log','stock.count','report.export','cust.edit'] },
